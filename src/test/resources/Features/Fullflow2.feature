@workflow1
Feature: FullCreate Subject and Sc23


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLow1
  Scenario Outline: Full CallSchedule with different Sche23
