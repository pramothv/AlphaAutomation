...
Feature: Workflow - Creation of Subject with Scheduling different Visits


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowSchedulingVisits1
  Scenario Outline: Workflow - Creation of Subject with Scheduling different Visits
