@testing
Feature: FullCreate Subject and Sc


  @testinCallS1
  Scenario Outline: Full CallSchedule with different Sche
...
#    And I navigate to ScheduleInfo section and must capture "<date1>""<time1>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
    And I navigate to ScheduleInfo section and should capture "<date1>""<time1>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
#    And I navigate to Schedule a Call screen and must capture "<title>" "<ScheduleCallsubject>""<ScheduleCallsitestaff>"
...
#    And I visit JConnect WebApp and click on Screening
    ...
    And I click on DiaryBack button and check Screen Status
...
#    And I switch to WebApp and select WeekOne Baseline option
    ...
    And I navigate to ScheduleInfo section and should be able to capture "<date1>""<time1>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
...
#    And I navigate to JConnect Subject List and enter "<subNum>" and fetch the record
