...
Feature: Workflow - Creation of Subject and SchedulesFlow and validation fullschedule1


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowfullschedule1
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and validation fullschedule1
