...
Feature: Workflow - Creation of Subject and SchedulesFlow and validation checks


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowfin
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and validation checks
