...
Feature: Workflow - Creation of Subject with Scheduling different VisitsC


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowSchedulingVisits1C
  Scenario Outline: Workflow - Creation of Subject with Scheduling different VisitsC
...
#    And I launch JConnect WebApp with "<PhoneCode>""<phoneNum>" password and join the Safer meeting from WebApp and conclude
    ...
    And I launch JConnect and capture "<username>""<password>" and must click Signin
#    And I launch JConnect and capture "<username>""<password>" and click Signin
    And I click on JConnectBuild Option
    And I click on CallSchedule and capture "<time>""<study>""<site>""<subject>""<sitestaff>" and click on Schedule Visit
...
#    And I must navigate to ScheduleInfo section and capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
    And I must navigate to ScheduleInfo section and must capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
...
#    And I should be able to navigate to ScheduleInfo section and capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
    And I must be able to navigate to the ScheduleInfo section and should capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
...
#    And I navigate to Jconnect CallSchedule capture "<ScheduleCallsubject>" and launch WeekOneBaseline meeting
    And I navigate to Jconnect CallSchedule capture "<ScheduleCallsubject>" and launch WeekOne meeting
    And I must join the meeting from JConnect
#    And I launch JConnect WebApp with "<PhoneCode>""<phoneNum>" password and join the Screening meeting from WebApp and conclude
#    And I launch JConnect WebApp with "<PhoneCode>""<phoneNum>" password and join the WeekOneBaseline meeting from WebApp and conclude
    And I launch JConnect WebApp with "<PhoneCode>""<phoneNum>" password and join the WeekOne meeting from WebApp and conclude


    And I navigate to Jconnect CallSchedule capture "<ScheduleCallsubject>" and launch Unscheduled meeting
    And I must join the meeting from JConnect
#    And I launch JConnect WebApp with "<PhoneCode>""<phoneNum>" password and join the Screening meeting from WebApp and conclude
#    And I launch JConnect WebApp with "<PhoneCode>""<phoneNum>" password and join the WeekOneBaseline meeting from WebApp and conclude
