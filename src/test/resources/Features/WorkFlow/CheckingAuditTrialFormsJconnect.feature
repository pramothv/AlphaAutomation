...
Feature: Workflow - Creation of Subject and SchedulesFlow and and Checking AuditTrial FormsB


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowAuditTrialB
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and Checking AuditTrial FormsB
