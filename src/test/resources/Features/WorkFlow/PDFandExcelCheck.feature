...
Feature: Workflow - Creation of Subject and SchedulesFlow and PDf and Excel check


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowAudiPDf
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and PDf and Excel check
