...
Feature: Workflow - Creation of Subject and Schedulesflow


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowflow
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and validation flow
