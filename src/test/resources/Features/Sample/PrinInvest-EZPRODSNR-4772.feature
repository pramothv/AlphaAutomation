...
Feature: SmokeTest Scenario - Principal Investigator: EZPRODSNR-4772


   #JIRA:SmokeTest EZPRODSNR-4731 EZPRODSNR-4667
  @testiScenario
  Scenario Outline: SmokeTest Scenario - Principal Investigator: EZPRODSNR-4772
...
#    And I must navigate to ScheduleInfo section and must be able to capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
  ...
  #    And I navigate to Subject List and enter "<subNum1>" and fetch the record
   ...
   And I navigate to UserManagement List Tab and capture "<name>" and click Next and Next and Previous buttons
    ...
    And I navigate to JConnect Chat section and click NewChat and capture "<users>""<subject>""<message>"
