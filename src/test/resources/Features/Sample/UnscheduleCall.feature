...
Feature: UnscheduleCall validation check


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWoUnscheduleCall
  Scenario Outline: UnscheduleCall validation check
...
#    And I must be able to navigate to ScheduleInfo section and must capture "<date1>""<timehours1>""<timemins1>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
