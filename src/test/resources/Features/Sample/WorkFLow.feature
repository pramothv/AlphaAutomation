...
Feature: Workflow Scenario - Creation of Subject and SchedulesFlow and validation check


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLScenario2
  Scenario Outline: Workflow Scenario - Creation of Subject with Scheduling Visits and validation check
...
#    And I navigate to Subject List and must enter "<subNum>" and must be able to fetch the record
...
#    And I must navigate to ScheduleInfo section and should capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"

#    And I should navigate to ScheduleInfo section and should be able to capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
    And I must navigate to ScheduleInfo section and must be able to capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
...
#    And I should be able to navigate to the ScheduleInfo section and must capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
#    And I must navigate to ScheduleInfo section and should capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"

    And I must be able to navigate to ScheduleInfo section and capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
#    And I must be able to navigate to the ScheduleInfo section and capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
...
#    And I click on CallSchedule and capture "<time>""<study>""<site>""<subject>""<sitestaff>" and click on Schedule Visit
#    And I navigate to Schedule a Call screen and should be able to capture "<title6>""<ScheduleCallsubject>""<ScheduleCallsitestaff>"
#    And I navigate to VisitDetails section and click on UnscheduledVisit option
#    And I navigate to Questionnaire and must be able to capture "<questionnaire1>""<questionnaire2>""<questionnaire3>"
#    And I must be able to navigate to ScheduleInfo section and must capture the "<date1>""<timehours1>""<timemins1>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
