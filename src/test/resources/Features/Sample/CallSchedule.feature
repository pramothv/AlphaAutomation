...
Feature: Create Subject and Schedule1234
  ...
  @testinsamwer1234
Scenario Outline: CallSchedule with different calla

    Given I capture "<username1>""<password>" and click Login for jConnect

#Given I capture "<username>""<password>" and click Signin
#    Given I capture "<username>""<password>" and click Signin forJConnect ALTO SetUp
...
Examples:
| username     |password  |username1       |ScheduleCallsubject1   |ScheduleCallsubject|
| JASC2        |Pass@123  | DAPPrime       |AA45(AA45 Ad)        |AA45                 |
