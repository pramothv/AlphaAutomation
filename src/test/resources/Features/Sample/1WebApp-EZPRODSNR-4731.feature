...
Feature: SmokeTest Scenario - WebApp: EZPRODSNR-4667


   #JIRA:SmokeTest EZPRODSNR-4731 EZPRODSNR-4667
  @1testingSmokeTest4731
  Scenario Outline: SmokeTest Scenario- WebApp: EZPRODSNR-4667
...
#    And I navigate to StudyList List and capture "<studyNum>" and fetch the record
    And I navigate to StudyList List and should capture "<studyNum>" and fetch the record
#    And I navigate to StudyList List and must capture "<studyNum>" and fetch the record
...
#    And I click on Subject and CreateSubject Option and should capture "<firstname>""<lastname>""<site>""<subNum>""<subExtID>""<phoneCode>""<phoneNum>""<email>""<role>""<startDate>""<language>"
...
#    And I navigate to Schedule a Call screen and must capture "<title>" "<ScheduleCallsubject>""<ScheduleCallsitestaff>"
    And I navigate to Schedule a Call screen and should capture "<title>" "<ScheduleCallsubject>""<ScheduleCallsitestaff>"
...
#    And I navigate to CallSchedule and ScheduleTelevisit for Screening and should capture "<title1>" "<ScheduleCallsubject>""<ScheduleCallsitestaff>"
    And I navigate to Schedule a Call screen and should capture "<title1>" "<ScheduleCallsubject>""<ScheduleCallsitestaff>"
...
#    And I must navigate to ScheduleInfo section and must be able to capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
    And I must navigate to ScheduleInfo section and should be able to capture "<date1>""<timehours>""<timemins>""<timetype>""<timeZone>""<calldurationHrs>""<calldurationMins>""<alert>"
