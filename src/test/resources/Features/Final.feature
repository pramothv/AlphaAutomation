...
Feature: Workflow - Creation of Subject and SchedulesFlow and validation Checksfinal2


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowfinal23
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and validation Checksfinal2
