...
Feature: Workflow - Creation of Subject and SchedulesFlow and validation Checksfinal


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowfinal
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and validation Checksfinal
