...
Feature: Workflow - Creation of Subject and SchedulesflowflowPartial


   #JIRA:EZPRODSNR-5626 WorkFLow Scenario
  @testingWorkFLowflowflowPartial
  Scenario Outline: Workflow - Creation of Subject with Scheduling Visits and validation flowPartial
